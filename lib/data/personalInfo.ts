export const personalInfo = {
  ...
  tagline: "Digital product studio for company profile, internal dashboard, and custom web systems",
  headline: "Building websites and internal tools that make businesses look serious and work cleaner.",
  narrative: "I run nasaq.id as a digital product studio focused on practical web systems for real operations. From company profiles and internal dashboards to logistics QC flows, retail tools, and custom admin systems, every build is shaped by a concrete business bottleneck.",
  ...
  skills: {
    ...
    specialties: ["Full-Stack Apps", "Web3/Solana", "QR Systems", "Real-time Analytics", "DDD Architecture"],
    proficiency: {
