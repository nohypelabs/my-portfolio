export const personalInfo = {
  ...
  narrative: "CS graduate who came back after a 9-year break — then shipped 15+ production apps in under a year using AI-augmented development. From POS systems handling real transactions to algorithmic trading bots, I solve real problems with modern tech.",
