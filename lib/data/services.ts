...
export const faqs: FAQ[] = [
  ...
  { id: '2', question: 'Apakah bisa custom sesuai kebutuhan bisnis saya?', answer: 'Tentu! Semua project dibuat custom dari nol sesuai kebutuhan Anda. Tidak pakai template. Setiap fitur didesain untuk menyelesaikan masalah spesifik bisnis Anda.', category: 'project', sort_order: 2, is_active: true, ...stamp },
  { id: '3', question: 'Teknologi apa yang digunakan?', answer: 'Stack utama: Next.js, React, TypeScript untuk web. Kotlin/Flutter untuk Android. PostgreSQL/Supabase untuk database. Deploy di Vercel/Railway. Semua teknologi modern dan production-proven.', category: 'technical', sort_order: 3, is_active: true, ...stamp },
  ...
  { id: '9', question: 'Saya tidak paham teknis — apakah tetap bisa bekerja sama?', answer: 'Justru itu kondisi yang paling umum. Kami tidak memakai jargon di proses kerja sama: brief diterjemahkan ke bahasa operasional, Anda cukup konfirmasi alur kerja yang benar, sisanya kami yang kerjakan. Anda akan selalu melihat hasil dalam bentuk yang bisa dicek langsung, bukan diagram teknis.', category: 'project', sort_order: 9, is_active: true, ...stamp },
