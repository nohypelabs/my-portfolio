export const cvData = {
  ...
  workExperience: [
    {
      year: "2015",
      title: "Mocha Loco Cafe and Resto",
      description: {
        en: "Waiter — 3 months (semester break)",
        id: "Waiter — 3 bulan (masa libur kuliah)",
      },
    },
    {
      year: "2017 – 2018",
      title: "Agen JNE Sudirman 2",
      description: {
