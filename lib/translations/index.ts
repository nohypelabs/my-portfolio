export const translations = {
  en: {
    ...
    letsWorkDesc: "I build production systems with Next.js, tRPC & PostgreSQL. Available for full-time roles, contract work, or project-based freelance. Ship fast, write clean code, own the entire stack.",
  ...
  id: {
    ...
    letsWorkDesc: "Saya membangun sistem production dengan Next.js, tRPC & PostgreSQL. Tersedia untuk posisi full-time, kontrak, atau freelance per proyek. Cepat, kode bersih, menguasai seluruh stack.",
