        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full border border-[#c4956a]/20 bg-[#f7f3e8] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#a67d55]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              {project.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-[22px] border border-neutral-400 bg-white px-5 py-3 text-sm font-semibold text-neutral-900 transition-colors hover:bg-[#f7f3e8]"
                >
