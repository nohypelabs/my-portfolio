...
export function ProcessContent({ steps }: { steps: ProcessStep[] }) {
  return (
    <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-10">
        ...
        <div className="space-y-6">
          {steps.map((step) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-[#f7f3e8] border-2 border-[#c4956a] flex items-center justify-center flex-shrink-0 z-10">
                  <Icon className="w-5 h-5 text-[#c4956a]" strokeWidth={1.5} />
                </div>

                <div className="flex-1 bg-[#f7f3e8] border border-neutral-200 rounded-xl p-5 hover:border-[#c4956a]/30 hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-[11px] font-medium text-[#c4956a] bg-[#c4956a]/10 px-2 py-0.5 rounded-full">
      ...
      {/* CTA */}
      <motion.div variants={fadeInUp} className="bg-[#c4956a]/5 border border-[#c4956a]/20 rounded-xl p-8 text-center">
