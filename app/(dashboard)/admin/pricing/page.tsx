    ...
    <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-8">
      ...
      <motion.div variants={fadeInUp} className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-[20px] font-semibold text-foreground">Kelola Paket Harga</h1>
      ...
      <div className="space-y-6">
        {packages.map((pkg) => (
          <motion.div
            key={pkg.id}
            variants={fadeInUp}
            className="bg-surface border border-foreground/20 rounded-[8px] p-6"
          >
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                <GripVertical className="w-4 h-4 text-neutral-300" />
                <h3 className="text-[15px] font-semibold text-foreground">{pkg.name}</h3>
                {pkg.is_popular && (
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-[12px] text-accent hover:text-accent-dark transition-colors"
                >
