  ...
  return (
    <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-8">
      ...
      <div className="space-y-6">
        {services.map((svc) => (
          <motion.div key={svc.id} variants={fadeInUp} className="bg-[#f7f3e8] border border-neutral-200 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              ...
              <div className="md:col-span-2">
                ...
                <textarea value={svc.description} onChange={e => updateField(svc.id, 'description', e.target.value)} rows={2}
                  className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-[13px] focus:outline-none focus:border-[#c4956a] focus:ring-1 focus:ring-[#c4956a]/20 resize-none" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <input type="number" value={svc.sort_order} onChange={e => updateField(svc.id, 'sort_order', parseInt(e.target.value) || 0)}
                  className="w-16 px-2 py-1 border border-neutral-300 rounded-lg text-[12px] focus:outline-none focus:border-[#c4956a]" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <button onClick={() => addFeature(svc.id)} className="flex items-center gap-1.5 text-[12px] text-[#c4956a] hover:text-[#a67d55] transition-colors">
